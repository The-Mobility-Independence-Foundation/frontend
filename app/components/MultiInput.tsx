        ...
        <div className="flex mb-6">
            {inputs.map((inputInfo, i) => (
                <Fragment key={inputInfo.placeholder}>
                    <Input placeholder={inputInfo.placeholder} type={inputInfo.type} min={inputInfo.minValue} max={inputInfo.maxValue} onChange={(e) => inputInfo.onValueChange(e.target.value)}/>
